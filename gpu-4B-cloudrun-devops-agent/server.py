...
MODEL_NAME = os.getenv("MODEL_NAME", "/mnt/models/gemma-4-E4B-it")
...
DEFAULT_SERVICE_NAME = os.getenv("SERVICE_NAME", "gpu-4b-l4-devops-agent")
...
def cloudrun_get_gpu_deployment_config(
    cluster_name: str = "gpu-cluster", model_name: str = "google/gemma-4-E4B-it"
) -> str:
    """
    ...
    Args:
        ...
        model_name: The model identifier (e.g., 'google/gemma-4-E4B-it').
    """
    manifest = f"""
### 🌀 vLLM on GPU (GKE Deployment)

To deploy vLLM on GPUs, use the following GKE manifest. This configuration targets a single **NVIDIA L4 GPU** which is ideal for Gemma 4 E4B.
...
@mcp.tool()
def cloudrun_get_vertex_ai_model_copy_instructions(model_name: str = "gemma-4-E4B-it") -> str:
    """
